...
export declare function add<T, A = T>(l: L<T, A>, tag: string, value: string|number|T, tp: SelectionTp): L<T, A>;
/**select all elements */
...
export declare function list<T, A = T>(l: L<T, A>, tag: string): T[];
